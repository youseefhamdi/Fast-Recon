# Create a comprehensive code example for MCP integration with reconnaissance tools
code_example = '''
...
with open('mcp_recon_server.py', 'w') as f:
    f.write(code_example)

print("MCP Recon Server code example created successfully!")
print("File saved as: mcp_recon_server.py")
print(f"Code length: {len(code_example)} characters")